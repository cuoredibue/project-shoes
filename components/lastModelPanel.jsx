...
const LastModelPanel = (props) => {
  ...
  return (
    <div className="px-2 py-8 space-y-6 bg-white text-center">
      <h2 className="font-semibold">Novità</h2>
      <h1 className="font-black text-5xl 2xl:text-7xl tracking-tighter">
        {promoTitle}
      </h1>
      <p>{description}</p>
      <Link
      ...
      >
        <button className="bg-black hover:bg-gray-500 rounded-full text-white px-8 mt-6 py-2">
          Acquista
        </button>
      </Link>
    </div>
